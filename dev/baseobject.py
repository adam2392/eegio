...
class BaseMeta(object):
    ...
    def format_metadata(metadata):
        ...
        metadata['filename'] = metadata['filename'].lower()
        # BaseMeta.map_filename(
    ...
    def map_filename(filename):
        ...
        # always add _ after type of timeseries identifier
