...
class PerturbationResult(Result):
    ...
    Examples
    --------
    >>> from eegio.objects.timeseries.perturbationresult_object import PerturbationResult
...
class FragilityModelResult(Result):
    ...
    Examples
    --------
    >>> from eegio.objects.timeseries.perturbationresult_object import FragilityModelResult
    >>> simulated_result = np.random.rand((80,100))
    >>> metadata = dict()
    >>> resultobj = PerturbationResult(simulated_result, metadata)
    """
