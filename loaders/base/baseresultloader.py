...
from eztrack.eegio.loaders.base.baseio import BaseIO
from eztrack.eegio.utils.utils import load_szinds
from eztrack.eegio.utils.utils import merge_metadata
...
class BaseResultsLoader(BaseIO):
    ...
    def update_metadata(self, metadata):
        ...
        :param metadata: (dict) the metadata for this result dataset.
