...
from eztrack.base.config.dataconfig import SCALP_REFERENCES
from eztrack.eegio.loaders.dataset.timeseries.recording import Recording
...
class ScalpRecording(Recording):
    ...
    --------
    >>> import numpy as np
    >>> from eztrack.eegio.loaders.dataset.timeseries.scalprecording import ScalpRecording
    >>> jsonfilepath = ""
    >>> root_dir = ""
    ...
    def create_raw_with_montage(self, eegobject, remove=True):
        """
        Function to create a mne.Io.Raw object with a specific montage for scalp EEG dataset.
