...
from eztrack.eegio.loaders.base.baseraw import BaseRawLoader
...
class Recording(BaseRawLoader):
    ...
    def extract_recording_metadata(self):
        ...
        if 'filename' in self.metadata.keys():
            ...
            record_filename = os.path.basename(self.jsonfilepath).replace(".json", "_raw.fif")
    ...
    def loadpipeline(self):
        ...
        :return: ts_object (TimeSeries) data object.
        """
