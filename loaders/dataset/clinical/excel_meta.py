...
from eztrack.eegio.objects.clinical.clinical_object import ClinicalScalpMeta, ClinicalPatientMeta, \
    ClinicalDatasetMeta
from eztrack.eegio.utils.clinical import expand_channels
